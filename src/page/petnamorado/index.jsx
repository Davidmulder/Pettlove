...
import rawCouples from '../../data/petCouples.json'  // json os esta as imagens dos pets
...
import './styles.css'
const couples = rawCouples.map(c => ({
  ...c,
...
export function PetsNamorando() {
  ...
  const firstList = couples.slice(0, 6)  // antes do banner
  ...
  return (
      ...
      >
        <section className="title-section">
          <h1>Pets <span>namorando</span></h1>
